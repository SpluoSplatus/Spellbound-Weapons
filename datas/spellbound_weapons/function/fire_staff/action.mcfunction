...
execute as @s[predicate=spellbound_weapons:holding/weapon/fire_staff,scores={spellbound_f_staff_cooldown=50}] at @s run item modify entity @s weapon.mainhand spellbound_weapons:fire_staff_ready
execute as @s[predicate=spellbound_weapons:holding/weapon/fire_staff_offhand,scores={spellbound_f_staff_cooldown=50}] at @s run item modify entity @s weapon.offhand spellbound_weapons:fire_staff_ready
...
#click
execute as @s[scores={spellbound_f_staff_cooldown=50..,spellbound_right_click=1..}] at @s positioned ~ ~1.5 ~ run function spellbound_weapons:fire_staff/attack
