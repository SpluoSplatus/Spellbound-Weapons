recipe take @s spellbound_weapons:ice_staff
advancement revoke @s only spellbound_weapons:ice_staff
...
execute if entity @s[nbt={Inventory:[{id:"minecraft:knowledge_book",Count:1b,tag:{CustomModelData:47007}}]}] run function spellbound_weapons:ice_staff/crafted
