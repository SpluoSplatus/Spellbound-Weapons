...
execute as @s[scores={spellbound_count=60..},tag=!spellbound_bone_wand_area_lure] run function spellbound_weapons:bone_wand/break

## break (lure I) - 4 seconds
execute as @s[scores={spellbound_count=80..},tag=spellbound_bone_wand_area_lureI] run function spellbound_weapons:bone_wand/break

## break (lure II) - 5 seconds
execute as @s[scores={spellbound_count=100..},tag=spellbound_bone_wand_area_lureII] run function spellbound_weapons:bone_wand/break

## break (lure III) - 6 seconds
execute as @s[scores={spellbound_count=120..},tag=spellbound_bone_wand_area_lureIII] run function spellbound_weapons:bone_wand/break
...
execute unless block ~ ~ ~ bone_block run function spellbound_weapons:bone_wand/break
