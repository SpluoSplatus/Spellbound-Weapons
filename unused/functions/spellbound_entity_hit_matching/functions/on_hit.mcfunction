...
execute at @s as @p[scores={spellbound_end=1..},distance=..5] if score @s spellbound_end matches 1 if score @s spellbound_cooldown matches 60..199 as @e[sort=nearest,limit=1] run function 1_splatus:spellbound/other/hits/end_excalibur


#### blazing ####

execute at @s as @p[scores={spellbound_blazing=1..},distance=..5] at @s if score @s spellbound_blazing matches 1 run function 1_splatus:spellbound/other/hits/blazing

#### SEA ####
execute at @s as @p[distance=..5,scores={spellbound_curse=1..}] if score @s spellbound_curse matches 1 as @e[sort=nearest,limit=1] run function 1_splatus:spellbound/other/hits/cursed_sea_blade
#### Golden Sea Blade ####
...
### SLOWNESS SWORD ###
execute at @s as @p[distance=..5,scores={spellbound_sand=1..}] if score @s spellbound_sand matches 1 as @e[sort=nearest,limit=1] run function 1_splatus:spellbound/other/hits/windswept


### WITHERING ###
execute at @s as @p[scores={spellbound_withering=1..},distance=..5] if score @s spellbound_withering matches 1 as @e[sort=nearest,limit=1] run function 1_splatus:spellbound/other/hits/withering
...
### MEGA HAMMER
execute at @s as @p[scores={spellbound_hammer=1..},distance=..5] if score @s spellbound_hammer matches 1 as @e[sort=nearest,limit=1] run function 1_splatus:spellbound/other/hits/mega_hammer
...
execute at @s as @p[scores={spellbound_evoker=1..},distance=..5] at @s if score @s spellbound_evoker matches 1 if score @s spellbound_evoker_cooldown matches 50.. run function 1_splatus:spellbound/other/hits/evokers_wrath



#### netherlight op

execute at @s as @p[scores={spellbound_netherlight=1..},distance=..5] at @s if score @s spellbound_netherlight matches 1 if score @s spellbound_netherlight_cooldown matches 20 run function 1_splatus:spellbound/netherlight/summon_beam2
...
### MOONLIGHT 
execute at @s as @p[scores={spellbound_moonlight_edge=1..},distance=..5] at @s if score @s spellbound_moonlight_edge matches 1 run function 1_splatus:spellbound/other/hits/moonlight_edge
