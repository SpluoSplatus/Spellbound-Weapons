...
#durability mainhand
execute as @s[predicate=spellbound_weapons:holding/weapon/fire_staff,predicate=!spellbound_weapons:holding/enchant/unbreaking1-3] if predicate spellbound_weapons:chance/50_percent run item modify entity @s[gamemode=!creative] weapon.mainhand spellbound_weapons:damage2
...
#durability offhand
execute as @s[predicate=spellbound_weapons:holding/weapon/fire_staff_offhand,predicate=!spellbound_weapons:holding/enchant/unbreaking1-3_offhand] if predicate spellbound_weapons:chance/50_percent run item modify entity @s[gamemode=!creative] weapon.offhand spellbound_weapons:damage2
