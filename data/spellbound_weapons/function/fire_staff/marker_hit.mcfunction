...
execute as @a[distance=..2] at @s as @a if score @s spellbound_uuid = @n[type=marker,tag=spellbound_firestaff] spellbound_uuid if score @s spellbound_uuid2 = @n[type=marker,tag=spellbound_firestaff] spellbound_uuid2 if score @s spellbound_uuid3 = @n[type=marker,tag=spellbound_firestaff] spellbound_uuid3 if score @s spellbound_uuid4 = @n[type=marker,tag=spellbound_firestaff] spellbound_uuid4 run damage @p 8 spellbound_weapons:magic by @s


#execute as @e[distance=..2,type=!#spellbound_weapons:misc] run data merge entity @s {Fire:60s}

#damage
execute as @a if score @s spellbound_uuid = @n[type=marker,tag=spellbound_firestaff] spellbound_uuid if score @s spellbound_uuid2 = @n[type=marker,tag=spellbound_firestaff] spellbound_uuid2 if score @s spellbound_uuid3 = @n[type=marker,tag=spellbound_firestaff] spellbound_uuid3 if score @s spellbound_uuid4 = @n[type=marker,tag=spellbound_firestaff] spellbound_uuid4 run tag @s add spellbound_temp5
execute as @e[distance=..1,type=!#spellbound_weapons:misc] run damage @s 8 spellbound_weapons:explosion by @p[tag=spellbound_temp5]
