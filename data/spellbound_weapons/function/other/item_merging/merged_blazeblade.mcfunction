...
summon item ~ ~ ~ {PickupDelay:20,Tags:["spellbound_item_blazeblade","spellbound_crafteditem"],Item:{id:"minecraft:iron_sword",count:1,components:{custom_model_data:{floats:[47048]},custom_data:{SpellboundItem:1b,BlazingSword:1b},max_damage:600,attribute_modifiers:[],item_name:{"translate":"Blazeblade","color":"#ff8400","italic":false},custom_name:{"translate":"Blazeblade","color":"#ff8400","italic":false},lore:[ [ {"translate":"Grindstone Repair: ","color":"gray","italic": false}],[{"translate":"  ","color":"gray","italic": false},{"color":"blue","italic": false,"translate":"item.minecraft.iron_sword"}],{"translate":"Spellbound Weapons","color":"#676e75","italic": true} ]}}}
