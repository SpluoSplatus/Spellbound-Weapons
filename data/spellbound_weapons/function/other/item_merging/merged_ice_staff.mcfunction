...
summon item ~ ~ ~ {PickupDelay:20,Tags:["spellbound_item_blazeblade","spellbound_crafteditem"],Item:{id:"minecraft:fishing_rod",count:1,components:{custom_model_data:{floats:[47011]},custom_data:{SpellboundItem:1b,SpellboundIceStaff:1b},max_damage:250,attribute_modifiers:[],item_name:{"translate":"Ice Staff","color":"#1c99ff","italic":false},custom_name:{"translate":"Ice Staff","color":"#1c99ff","italic":false},lore:[ [ {"translate":"Grindstone Repair: ","color":"gray","italic": false}],[{"translate":"  ","color":"gray","italic": false},{"color":"blue","italic": false,"translate":"item.minecraft.fishing_rod"}],{"translate":"Spellbound Weapons","color":"#676e75","italic": true} ]}}}
