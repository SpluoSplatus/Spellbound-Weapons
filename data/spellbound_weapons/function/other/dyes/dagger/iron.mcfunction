...
data modify entity @s Item.tag.CustomModelData set value 47018
data modify entity @s Item.tag.display set value {Name:'{"translate":"Dagger","color":"#91e060","italic":false}',Lore:['{"translate":"Variant: Iron-Plated","color":"gray","italic":false}','{"translate":"Spellbound Weapons","color":"#676E75","italic":true}']}
