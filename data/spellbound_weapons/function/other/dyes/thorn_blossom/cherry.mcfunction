...
data modify entity @s[nbt={Item:{id:"minecraft:diamond_sword"}}] Item.components.minecraft:item_name set value "{\"translate\":\"Thorn Blossom\",\"color\":\"#eb73a1\",\"italic\":false}"

data modify entity @s[nbt={Item:{id:"minecraft:iron_sword"}}] Item.components.minecraft:lore set value ["{\"translate\":\"Variant: Cherry\",\"color\":\"gray\",\"italic\":false}","[ {\"translate\":\"Grindstone Repair: \",\"color\":\"gray\",\"italic\": false}]","[{\"translate\":\"  \",\"color\":\"gray\",\"italic\": false},{\"color\":\"blue\",\"italic\": false,\"translate\":\"item.minecraft.iron_sword\"}]","{\"translate\":\"Spellbound Weapons\",\"color\":\"#676E75\",\"italic\":true}"]

data modify entity @s[nbt={Item:{id:"minecraft:diamond_sword"}}] Item.components.minecraft:lore set value ["{\"translate\":\"Variant: Cherry\",\"color\":\"gray\",\"italic\":false}","[ {\"translate\":\"Grindstone Repair: \",\"color\":\"gray\",\"italic\": false}]","[{\"translate\":\"  \",\"color\":\"gray\",\"italic\": false},{\"color\":\"blue\",\"italic\": false,\"translate\":\"item.minecraft.diamond_sword\"}]","{\"translate\":\"Spellbound Weapons\",\"color\":\"#676E75\",\"italic\":true}"]


kill @e[sort=nearest,type=item,nbt={Item:{id:"minecraft:cherry_sapling"}},limit=1]
