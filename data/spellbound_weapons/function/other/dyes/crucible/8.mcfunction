...
data modify entity @s Item.components.minecraft:custom_model_data set value {"floats":[47208]}
data modify entity @s Item.components.minecraft:custom_name set value {"translate":"Crucible","color":"#2253d0","italic":false}
