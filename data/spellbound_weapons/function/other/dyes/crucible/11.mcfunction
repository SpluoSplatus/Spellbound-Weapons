...
data modify entity @s Item.components.minecraft:custom_model_data set value 47211
data modify entity @s Item.components.minecraft:item_name set value "{\"translate\":\"Crucible\",\"color\":\"#F38BAA\",\"italic\":false}"
