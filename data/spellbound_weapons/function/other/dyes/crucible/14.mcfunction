...
particle block{block_state:"light_gray_concrete"} ~ ~.75 ~ .25 0 .25 1 5 force @a[distance=..32]

data modify entity @s Item.components.minecraft:custom_data.CrucibleDye set value 14b
data modify entity @s Item.components.minecraft:custom_model_data set value 47214
data modify entity @s Item.components.minecraft:item_name set value "{\"translate\":\"Crucible\",\"color\":\"#b8bebf\",\"italic\":false}"
