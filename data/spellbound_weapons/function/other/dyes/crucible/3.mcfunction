...
data modify entity @s Item.components.minecraft:custom_model_data set value {"floats":[47203]}
data modify entity @s Item.components.minecraft:custom_name set value {"translate":"Crucible","color":"#FED83D","italic":false}
