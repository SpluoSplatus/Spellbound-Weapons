...
particle block{block_state:"white_concrete"} ~ ~.75 ~ .25 0 .25 1 5 force @a[distance=..32]


data modify entity @s Item.components.minecraft:custom_data.CrucibleDye set value 13b
data modify entity @s Item.components.minecraft:custom_model_data set value {"floats":[47213]}
data modify entity @s Item.components.minecraft:custom_name set value {"translate":"Crucible","color":"#c4fff7","italic":false}
...
kill @e[sort=nearest,type=item,nbt={Item:{id:"minecraft:white_dye"}},limit=1]