...
execute unless score spellbound_recipes spellbound_count matches 0 run function spellbound_weapons:other/recipe_message



#fried weapon lol
execute as @a[predicate=spellbound_weapons:holding/tag/spellbound_netherite_sword] at @s run title @s[tag=!1_splatus_actionbar_disabled] actionbar {"translate":"Your weapon burned whilst converting to netherite. Drop it on the ground to revert it back"}
