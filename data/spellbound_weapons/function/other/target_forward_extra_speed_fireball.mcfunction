...
execute store result entity @s Motion[0] double 0.008 run scoreboard players get @s spellbound_x2
execute store result entity @s Motion[1] double 0.008 run scoreboard players get @s spellbound_y2
execute store result entity @s Motion[2] double 0.008 run scoreboard players get @s spellbound_z2

execute store result entity @s power[0] double 0.0012 run scoreboard players get @s spellbound_x2
execute store result entity @s power[1] double 0.0012 run scoreboard players get @s spellbound_y2
execute store result entity @s power[2] double 0.0012 run scoreboard players get @s spellbound_z2





tag @s add spellbound_motion
