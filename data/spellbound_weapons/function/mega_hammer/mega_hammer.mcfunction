...
item modify entity @s[nbt={SelectedItem:{tag:{display:{Name:'{"text":"Mega Hammer"}'}}}}] weapon.mainhand spellbound_weapons:name/mega_hammer
...
execute if score @s[predicate=spellbound_weapons:holding/enchant/efficency3] spellbound_hammer_cooldown matches ..2 run scoreboard players set @s spellbound_hammer_cooldown 6
