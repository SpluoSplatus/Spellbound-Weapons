...
execute if predicate spellbound_weapons:chance/20_percent run particle minecraft:block sand ~ ~1 ~ .5 .1 .5 .2 1 force @a[distance=..32]
...
execute as @s[tag=!spellbound_sand_wind_enchanted] positioned ~ ~-0.75 ~ as @e[distance=..0.75,type=!#spellbound_weapons:misc] run effect give @s slowness 1 1 false
execute as @s[tag=spellbound_sand_wind_enchanted] positioned ~ ~-0.75 ~ as @e[distance=..1,type=!#spellbound_weapons:misc] run effect give @s slowness 1 1 false

execute as @s[tag=!spellbound_sand_wind_enchanted] positioned ~ ~-0.75 ~ as @e[distance=..0.75,type=!#spellbound_weapons:misc] at @s run particle minecraft:block sand ~ ~.15 ~ .3 .3 .3 .2 25 force @a[distance=..32]
execute as @s[tag=spellbound_sand_wind_enchanted] positioned ~ ~-0.75 ~ as @e[distance=..1,type=!#spellbound_weapons:misc] at @s run particle minecraft:block sand ~ ~.15 ~ .3 .1 .3 .2 25 force @a[distance=..32]


execute positioned ~ ~-0.75 ~ if entity @e[distance=..1,type=!#spellbound_weapons:misc] as @a if score @s spellbound_uuid = @e[sort=nearest,limit=1,type=marker,tag=spellbound_sand_wind] spellbound_uuid if score @s spellbound_uuid2 = @e[sort=nearest,limit=1,type=marker,tag=spellbound_sand_wind] spellbound_uuid2 if score @s spellbound_uuid3 = @e[sort=nearest,limit=1,type=marker,tag=spellbound_sand_wind] spellbound_uuid3 if score @s spellbound_uuid4 = @e[sort=nearest,limit=1,type=marker,tag=spellbound_sand_wind] spellbound_uuid4 run tag @s add spellbound_temp5
...
execute as @e[distance=..2,type=item] at @s facing entity @e[sort=nearest,limit=1,type=marker,tag=spellbound_sand_wind] eyes run function spellbound_weapons:windswept_sword/push
