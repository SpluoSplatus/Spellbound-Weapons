...
execute unless score p spellbound_rotation2 matches -135..135 as @e[sort=nearest,limit=1,type=marker,tag=spellbound_sand_wind] at @s run function spellbound_weapons:windswept_sword/wind_hit
