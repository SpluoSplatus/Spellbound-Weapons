...
particle dust{color:[0.114,0.522,0.059],scale:1} ~ ~ ~ 0 0 0 0 1 force @a[distance=..128]

execute if entity @e[tag=spellbound_temp,distance=..0.5,type=marker] run scoreboard players set temp spellbound_count 20
execute unless score temp spellbound_count matches 20.. positioned ^ ^ ^.5 run function spellbound_weapons:thorn_blossom/particle_raycast
