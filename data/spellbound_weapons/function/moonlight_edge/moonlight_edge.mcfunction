...
item modify entity @s[nbt={SelectedItem:{tag:{display:{Name:'{"text":"Moonlight Edge"}'}}}}] weapon.mainhand spellbound_weapons:name/moonlight_edge
...
# RELEASE !!!
execute if score @s spellbound_moonlight_edge_cooldown matches 60.. if entity @s[predicate=spellbound_weapons:sneaking] unless score @s spellbound_moonlight_edge_fall_speed matches ..-2 run function spellbound_weapons:moonlight_edge/release_heavy_beam
