...
execute unless score p spellbound_rotation2 matches -135..135 positioned ~ ~1 ~ positioned ^ ^ ^.25 as @e[sort=nearest,limit=1,type=area_effect_cloud,tag=spellbound_moonlight_edge_heavybeam] run function spellbound_weapons:moonlight_edge/hit
