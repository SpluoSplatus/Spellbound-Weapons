...
execute as @s[predicate=spellbound_weapons:holding/weapon/moonlight_edge,predicate=spellbound_weapons:holding/tag/0_durability] run particle minecraft:block amethyst_block ~ ~1 ~ .4 .3 .4 .4 30 normal
...
execute as @s[predicate=spellbound_weapons:holding/enchant/sweeping_edge3] positioned ~ ~.68 ~ run summon minecraft:area_effect_cloud ^ ^ ^1 {Duration:999999999,Tags:["spellbound_moonlight_edge_heavybeam","spellbound_moonlight_edge_heavybeam_sweeping"],CustomName:'{"translate":"Light Beam"}'}

execute as @s[predicate=!spellbound_weapons:holding/enchant/sweeping_edge3] positioned ~ ~.68 ~ run summon minecraft:area_effect_cloud ^ ^ ^1 {Duration:999999999,Tags:["spellbound_moonlight_edge_heavybeam"],CustomName:'{"translate":"Light Beam"}'}
