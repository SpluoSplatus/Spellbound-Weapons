...
execute if score @s spellbound_count matches 2.. as @e[dy=0,distance=..5,type=player,predicate=!spellbound_weapons:not_creative_spec] if entity @s[advancements={spellbound_weapons:used_shield=false},predicate=!spellbound_weapons:taking_damage] at @s run damage @s 1 spellbound_weapons:magic by @p[tag=spellbound_temp5]
execute if score @s spellbound_count matches 2.. as @e[dy=0,distance=..5,type=player,predicate=!spellbound_weapons:not_creative_spec] if entity @s[advancements={spellbound_weapons:used_shield=true},predicate=!spellbound_weapons:taking_damage] at @s run function spellbound_weapons:other/action/damage_shield
execute if score @s spellbound_count matches 2.. as @e[dy=0,distance=..5,type=player,predicate=!spellbound_weapons:not_creative_spec] if entity @s[advancements={spellbound_weapons:used_shield=true}] as @n[type=marker,tag=spellbound_moonlight_edge_beam] at @s run function spellbound_weapons:moonlight_edge/beam_hit
execute if score @s spellbound_count matches 2.. as @e[dy=0,distance=..5,type=!player,type=!#spellbound_weapons:misc,predicate=!spellbound_weapons:not_creative_spec] run damage @s 1 spellbound_weapons:magic by @p[tag=spellbound_temp5]
