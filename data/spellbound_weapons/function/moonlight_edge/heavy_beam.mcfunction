...
#damage
execute if score @s spellbound_count matches 2.. positioned ~ ~-1 ~ if entity @e[distance=..1.25,type=!#spellbound_weapons:misc] as @a if score @s spellbound_uuid = @e[sort=nearest,limit=1,type=area_effect_cloud,tag=spellbound_moonlight_edge_heavybeam] spellbound_uuid if score @s spellbound_uuid2 = @e[sort=nearest,limit=1,type=area_effect_cloud,tag=spellbound_moonlight_edge_heavybeam] spellbound_uuid2 if score @s spellbound_uuid3 = @e[sort=nearest,limit=1,type=area_effect_cloud,tag=spellbound_moonlight_edge_heavybeam] spellbound_uuid3 if score @s spellbound_uuid4 = @e[sort=nearest,limit=1,type=area_effect_cloud,tag=spellbound_moonlight_edge_heavybeam] spellbound_uuid4 run tag @s add spellbound_temp5

execute if score @s spellbound_count matches 2.. positioned ~ ~-1 ~ as @e[distance=..1.25,type=player,tag=!spellbound_player_usingbeam] if entity @s[advancements={spellbound_weapons:used_shield=true}] at @s run function spellbound_weapons:moonlight_edge/shield
execute if score @s spellbound_count matches 2.. positioned ~ ~-1 ~ as @e[distance=..1.25,type=player,tag=!spellbound_player_usingbeam] if entity @s[advancements={spellbound_weapons:used_shield=false},predicate=!spellbound_weapons:taking_damage] at @s run damage @s 8 spellbound_weapons:magic by @p[tag=spellbound_temp5]




execute if score @s spellbound_count matches 2.. unless block ~ ~ ~ #spellbound_weapons:permeable run function spellbound_weapons:moonlight_edge/hit

execute if score @s spellbound_count matches 2.. positioned ~ ~-1 ~ as @e[distance=..1.25,type=!player,type=!#spellbound_weapons:misc,tag=!spellbound_player_usingbeam,predicate=!spellbound_weapons:taking_damage] run damage @s 8 spellbound_weapons:magic by @p[tag=spellbound_temp5]
