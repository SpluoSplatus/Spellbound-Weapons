...
item modify entity @s[predicate=spellbound_weapons:holding/weapon/electric_staff,nbt={SelectedItem:{components:{"minecraft:custom_name":'"Electric Staff"'}}}] weapon.mainhand spellbound_weapons:name/electric_staff

execute if entity @s[predicate=spellbound_weapons:holding/weapon/electric_staff] run item modify entity @s weapon.mainhand spellbound_weapons:electric_staff
execute if entity @s[predicate=spellbound_weapons:holding/weapon/electric_staff_offhand] run item modify entity @s weapon.offhand spellbound_weapons:electric_staff


execute if score spellbound_nocooldown spellbound_settings matches 1 as @s[scores={spellbound_e_staff=1..,spellbound_e_staff_cooldown=..59},predicate=!spellbound_weapons:holding/tag/1_durability] at @s run scoreboard players set @s spellbound_e_staff_cooldown 39


#no amo? that sucks for you!
execute as @s[scores={spellbound_i_staff=1..,spellbound_right_click=1..},predicate=spellbound_weapons:holding/weapon/electric_staff,predicate=spellbound_weapons:holding/tag/1_durability] run function spellbound_weapons:ice_staff/low_durability
execute as @s[scores={spellbound_i_staff=1..,spellbound_right_click=1..},predicate=spellbound_weapons:holding/weapon/electric_staff_offhand,predicate=spellbound_weapons:holding/tag/1_durability_offhand] run function spellbound_weapons:ice_staff/low_durability
...
execute as @s[predicate=spellbound_weapons:holding/enchant/lure3,predicate=spellbound_weapons:holding/weapon/electric_staff] if score @s spellbound_e_staff_cooldown matches 1..2 run scoreboard players set @s spellbound_e_staff_cooldown 10
execute as @s[predicate=spellbound_weapons:holding/enchant/lure2,predicate=spellbound_weapons:holding/weapon/electric_staff] if score @s spellbound_e_staff_cooldown matches 1..2 run scoreboard players set @s spellbound_e_staff_cooldown 7
execute as @s[predicate=spellbound_weapons:holding/enchant/lure1,predicate=spellbound_weapons:holding/weapon/electric_staff] if score @s spellbound_e_staff_cooldown matches 1..2 run scoreboard players set @s spellbound_e_staff_cooldown 3

execute as @s[predicate=spellbound_weapons:holding/enchant/lure3_offhand,predicate=spellbound_weapons:holding/weapon/electric_staff_offhand] if score @s spellbound_e_staff_cooldown matches 1..2 run scoreboard players set @s spellbound_e_staff_cooldown 10
execute as @s[predicate=spellbound_weapons:holding/enchant/lure2_offhand,predicate=spellbound_weapons:holding/weapon/electric_staff_offhand] if score @s spellbound_e_staff_cooldown matches 1..2 run scoreboard players set @s spellbound_e_staff_cooldown 7
execute as @s[predicate=spellbound_weapons:holding/enchant/lure1_offhand,predicate=spellbound_weapons:holding/weapon/electric_staff_offhand] if score @s spellbound_e_staff_cooldown matches 1..2 run scoreboard players set @s spellbound_e_staff_cooldown 3
