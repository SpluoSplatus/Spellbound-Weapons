...
execute at @s if score @s[tag=spellbound_magmus_charger_arrow_mid] spellbound_count matches 1 store result score @n[type=area_effect_cloud,tag=spellbound_magmus_charger_arrow_area_mid] spellbound_uuid3 run data get entity @s Owner[2]
execute at @s if score @s[tag=spellbound_magmus_charger_arrow_mid] spellbound_count matches 1 store result score @n[type=area_effect_cloud,tag=spellbound_magmus_charger_arrow_area_mid] spellbound_uuid4 run data get entity @s Owner[3]
...
execute if entity @s[tag=spellbound_magmus_charger_arrow_mid,nbt={inGround:1b}] run function spellbound_weapons:magmus_charger/arrow/medium_arrow_hit

execute if entity @s[tag=spellbound_magmus_charger_arrow_max] run function spellbound_weapons:magmus_charger/summon
