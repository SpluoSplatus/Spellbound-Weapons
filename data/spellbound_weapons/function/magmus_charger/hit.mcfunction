...
#execute if score @s[tag=spellbound_magmus_charger_arrow_max_power5] spellbound_count matches 102 as @e[distance=..2,sort=nearest,limit=1,type=!#spellbound_weapons:misc] at @s run function spellbound_weapons:damage/armor_7
#execute if score @s[tag=spellbound_magmus_charger_arrow_max_power4] spellbound_count matches 102 as @e[distance=..2,sort=nearest,limit=1,type=!#spellbound_weapons:misc] at @s run function spellbound_weapons:damage/armor_6
#execute if score @s[tag=spellbound_magmus_charger_arrow_max_power3] spellbound_count matches 102 as @e[distance=..2,sort=nearest,limit=1,type=!#spellbound_weapons:misc] at @s run function spellbound_weapons:damage/armor_5
#death
#execute if score @s[tag=!spellbound_magmus_charger_arrow_max_power] spellbound_count matches 102 as @e[distance=..2,sort=nearest,limit=1,type=!#spellbound_weapons:misc] at @s run function spellbound_weapons:damage/armor_4

execute if score @s spellbound_count matches 102 as @s[tag=spellbound_magmus_charger_arrow_area_max_spectral] as @e[distance=..2,sort=nearest,limit=1,type=!#spellbound_weapons:misc] at @s run effect give @s glowing 12
...
execute if score @s spellbound_count matches 115.. run function spellbound_weapons:other/hits/magmus_max
