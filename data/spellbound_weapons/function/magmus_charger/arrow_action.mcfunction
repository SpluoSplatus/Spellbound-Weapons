...
execute as @p[scores={spellbound_magmus_charger=1..}] if score @s spellbound_magmus_charger_cooldown matches 80.. as @n[type=#spellbound_weapons:arrow] positioned ~ ~1.52 ~ run function spellbound_weapons:magmus_charger/summon
...
execute as @p[scores={spellbound_magmus_charger=1..}] if score @s spellbound_magmus_charger_cooldown matches 80.. as @n[type=#spellbound_weapons:arrow] anchored eyes run kill @s
