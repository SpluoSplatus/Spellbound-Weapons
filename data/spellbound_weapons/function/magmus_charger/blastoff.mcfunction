...
execute if score @s spellbound_blastoff matches 1..20 if predicate spellbound_weapons:chance/50_percent run particle firework ~ ~ ~ 0 0 0 0 1 force @a[distance=..64]
...
execute unless block ~ ~2 ~ #spellbound_weapons:air run scoreboard players set @s spellbound_blastoff 20
