...
execute unless score p spellbound_rotation2 matches -135..135 at @s run function spellbound_weapons:other/action/_shield
execute unless score p spellbound_rotation2 matches -135..135 positioned ~ ~1 ~ positioned ^ ^ ^.25 as @e[sort=nearest,limit=1,type=armor_stand,tag=spellbound_ice_staff_ice] run function spellbound_weapons:ice_staff/break_ice
