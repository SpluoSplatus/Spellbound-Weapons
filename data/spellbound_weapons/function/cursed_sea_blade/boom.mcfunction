...
execute if score @s spellbound_curse_cooldown matches 30 run function spellbound_weapons:cursed_sea_blade/actual_boom


execute if score @s spellbound_curse_cooldown matches 100.. at @s run function spellbound_weapons:cursed_sea_blade/push_up



execute unless predicate spellbound_weapons:sneaking run scoreboard players set @s spellbound_curse_cooldown 0
