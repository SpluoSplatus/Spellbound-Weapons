...
execute positioned ~ ~-1 ~ as @e[distance=..1,sort=nearest,limit=1,type=!player,type=!#spellbound_weapons:misc] as @s[type=!#spellbound_weapons:large] run damage @s 3 spellbound_weapons:projectile by @p[tag=spellbound_temp5]
execute positioned ~ ~-1.5 ~ as @e[distance=..3,sort=nearest,limit=1,type=!player,type=!#spellbound_weapons:misc] as @s[type=#spellbound_weapons:large] run damage @s 3 spellbound_weapons:projectile by @p[tag=spellbound_temp5]
...
#death
execute positioned ~ ~-1 ~ as @p[distance=..1,sort=nearest,limit=1] if entity @s[advancements={spellbound_weapons:used_shield=true}] run function spellbound_weapons:blowgun/shield
execute positioned ~ ~-1 ~ as @p[distance=..1,sort=nearest,limit=1] at @s if entity @s[advancements={spellbound_weapons:used_shield=false}] run damage @s 3 spellbound_weapons:projectile by @p[tag=spellbound_temp5]
