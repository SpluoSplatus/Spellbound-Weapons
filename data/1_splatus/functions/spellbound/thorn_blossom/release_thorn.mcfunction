...
execute as @s[predicate=1_splatus:spellbound/holding/enchant/sweeping_edge1] run scoreboard players set @e[sort=nearest,limit=1,type=marker,tag=spellbound_thorn] spellbound_enchantlevel 1
execute as @s[predicate=1_splatus:spellbound/holding/enchant/sweeping_edge2] run scoreboard players set @e[sort=nearest,limit=1,type=marker,tag=spellbound_thorn] spellbound_enchantlevel 2
execute as @s[predicate=1_splatus:spellbound/holding/enchant/sweeping_edge3] run scoreboard players set @e[sort=nearest,limit=1,type=marker,tag=spellbound_thorn] spellbound_enchantlevel 3 




execute if score @s spellbound_rotation matches 80..90 as @s[tag=!spellbound_tip.thorn_blossom_2,tag=spellbound_tip.thorn_blossom_1] run function 1_splatus:spellbound/other/tips/checkmark
