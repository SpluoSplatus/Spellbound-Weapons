...
execute at @s unless score @s spellbound_count matches 1000.. run function 1_splatus:spellbound/thorn_blossom/thorn_raycast
execute at @s[tag=!spellbound_thorn_end] if score @s spellbound_count matches 1000.. run function 1_splatus:spellbound/thorn_blossom/thorn_hit
