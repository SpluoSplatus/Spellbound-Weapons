...
execute if score @s[type=!#1_splatus:spellbound/misc] spellbound_crucible_stunned matches 1 run damage @s 14 1_splatus:spellbound/magic_force by @p[tag=spellbound_temp5]
