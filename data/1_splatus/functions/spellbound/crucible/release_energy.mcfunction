...
execute as @s[predicate=1_splatus:spellbound/holding/weapon/crucible,predicate=1_splatus:spellbound/holding/tag/0_durability] run particle minecraft:block redstone_block ~ ~1 ~ .4 .3 .4 .4 30 normal
execute as @s[predicate=1_splatus:spellbound/holding/weapon/crucible,predicate=1_splatus:spellbound/holding/tag/0_durability] run playsound item.shield.break player @a[distance=..16] ~ ~ ~ 1 1
execute as @s[predicate=1_splatus:spellbound/holding/weapon/crucible,predicate=1_splatus:spellbound/holding/tag/0_durability] run item replace entity @s weapon.mainhand with air
