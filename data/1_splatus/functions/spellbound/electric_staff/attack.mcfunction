...
#durability mainhand
execute as @s[predicate=1_splatus:spellbound/holding/weapon/electric_staff,predicate=!1_splatus:spellbound/holding/enchant/unbreaking1-3] if predicate 1_splatus:spellbound/chance/50_percent run item modify entity @s[gamemode=!creative] weapon.mainhand 1_splatus:spellbound/damage2
execute as @s[predicate=1_splatus:spellbound/holding/weapon/electric_staff,predicate=1_splatus:spellbound/holding/enchant/unbreaking1] if predicate 1_splatus:spellbound/chance/50_percent if predicate 1_splatus:spellbound/chance/50_percent run item modify entity @s[gamemode=!creative] weapon.mainhand 1_splatus:spellbound/damage2
execute as @s[predicate=1_splatus:spellbound/holding/weapon/electric_staff,predicate=1_splatus:spellbound/holding/enchant/unbreaking2] if predicate 1_splatus:spellbound/chance/50_percent if predicate 1_splatus:spellbound/chance/33_percent run item modify entity @s[gamemode=!creative] weapon.mainhand 1_splatus:spellbound/damage2
execute as @s[predicate=1_splatus:spellbound/holding/weapon/electric_staff,predicate=1_splatus:spellbound/holding/enchant/unbreaking3] if predicate 1_splatus:spellbound/chance/50_percent if predicate 1_splatus:spellbound/chance/25_percent run item modify entity @s[gamemode=!creative] weapon.mainhand 1_splatus:spellbound/damage2


#durability offhand
execute as @s[predicate=1_splatus:spellbound/holding/weapon/electric_staff_offhand,predicate=!1_splatus:spellbound/holding/enchant/unbreaking1-3_offhand] if predicate 1_splatus:spellbound/chance/50_percent run item modify entity @s[gamemode=!creative] weapon.offhand 1_splatus:spellbound/damage2
execute as @s[predicate=1_splatus:spellbound/holding/weapon/electric_staff_offhand,predicate=1_splatus:spellbound/holding/enchant/unbreaking1_offhand] if predicate 1_splatus:spellbound/chance/50_percent if predicate 1_splatus:spellbound/chance/50_percent run item modify entity @s[gamemode=!creative] weapon.offhand 1_splatus:spellbound/damage2
execute as @s[predicate=1_splatus:spellbound/holding/weapon/electric_staff_offhand,predicate=1_splatus:spellbound/holding/enchant/unbreaking2_offhand] if predicate 1_splatus:spellbound/chance/50_percent if predicate 1_splatus:spellbound/chance/33_percent run item modify entity @s[gamemode=!creative] weapon.offhand 1_splatus:spellbound/damage2
execute as @s[predicate=1_splatus:spellbound/holding/weapon/electric_staff_offhand,predicate=1_splatus:spellbound/holding/enchant/unbreaking3_offhand] if predicate 1_splatus:spellbound/chance/50_percent if predicate 1_splatus:spellbound/chance/25_percent run item modify entity @s[gamemode=!creative] weapon.offhand 1_splatus:spellbound/damage2
...
execute as @s[predicate=!1_splatus:spellbound/holding/enchant/luck_of_the_sea3,predicate=1_splatus:spellbound/holding/weapon/electric_staff] unless block ~ ~ ~ #1_splatus:spellbound/allows_water_dashing run summon marker ~ ~ ~ {Tags:["spellbound_electric_raycast","spellbound_marker"]}
execute as @s[predicate=1_splatus:spellbound/holding/enchant/luck_of_the_sea3,predicate=1_splatus:spellbound/holding/weapon/electric_staff] unless block ~ ~ ~ #1_splatus:spellbound/allows_water_dashing run summon marker ~ ~ ~ {Tags:["spellbound_electric_raycast","spellbound_electric_raycast_enchanted","spellbound_marker"]}

execute as @s[predicate=!1_splatus:spellbound/holding/enchant/luck_of_the_sea3_offhand,predicate=1_splatus:spellbound/holding/weapon/electric_staff_offhand] at @s unless block ~ ~ ~ #1_splatus:spellbound/allows_water_dashing run summon marker ~ ~ ~ {Tags:["spellbound_electric_raycast","spellbound_marker"]}
execute as @s[predicate=1_splatus:spellbound/holding/enchant/luck_of_the_sea3_offhand,predicate=1_splatus:spellbound/holding/weapon/electric_staff_offhand] at @s unless block ~ ~ ~ #1_splatus:spellbound/allows_water_dashing run summon marker ~ ~ ~ {Tags:["spellbound_electric_raycast","spellbound_electric_raycast_enchanted","spellbound_marker"]}
