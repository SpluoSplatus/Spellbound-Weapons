...
execute as @e[distance=..1,type=!#1_splatus:spellbound/misc,tag=!spellbound_electric_staff_immune] run damage @s 7 1_splatus:spellbound/magic by @p[tag=spellbound_temp5]
