...
execute if predicate 1_splatus:spellbound/chance/50_percent positioned ~ ~ ~-1 run function 1_splatus:spellbound/other/asset/summon_fire
execute if predicate 1_splatus:spellbound/chance/50_percent positioned ~ ~ ~1 run function 1_splatus:spellbound/other/asset/summon_fire
execute if predicate 1_splatus:spellbound/chance/50_percent positioned ~-1 ~ ~ run function 1_splatus:spellbound/other/asset/summon_fire
execute if predicate 1_splatus:spellbound/chance/50_percent positioned ~1 ~ ~ run function 1_splatus:spellbound/other/asset/summon_fire
function 1_splatus:spellbound/other/asset/summon_fire

execute if entity @s[tag=spellbound_firestaff_enchanted] positioned ~1 ~ ~1 if predicate 1_splatus:spellbound/chance/50_percent run function 1_splatus:spellbound/other/asset/summon_fire
execute if entity @s[tag=spellbound_firestaff_enchanted] positioned ~-1 ~ ~1 if predicate 1_splatus:spellbound/chance/50_percent run function 1_splatus:spellbound/other/asset/summon_fire
execute if entity @s[tag=spellbound_firestaff_enchanted] positioned ~-1 ~ ~-1 if predicate 1_splatus:spellbound/chance/50_percent run function 1_splatus:spellbound/other/asset/summon_fire
execute if entity @s[tag=spellbound_firestaff_enchanted] positioned ~1 ~ ~-1 if predicate 1_splatus:spellbound/chance/50_percent run function 1_splatus:spellbound/other/asset/summon_fire

execute as @a[distance=..2] at @s as @a if score @s spellbound_uuid = @e[sort=nearest,limit=1,type=marker,tag=spellbound_crucible_releasedenergy] spellbound_uuid if score @s spellbound_uuid2 = @e[sort=nearest,limit=1,type=marker,tag=spellbound_crucible_releasedenergy] spellbound_uuid2 if score @s spellbound_uuid3 = @e[sort=nearest,limit=1,type=marker,tag=spellbound_crucible_releasedenergy] spellbound_uuid3 if score @s spellbound_uuid4 = @e[sort=nearest,limit=1,type=marker,tag=spellbound_crucible_releasedenergy] spellbound_uuid4 run damage @p 10 1_splatus:spellbound/magic by @s


#execute as @e[distance=..2,type=!#1_splatus:spellbound/misc] run data merge entity @s {Fire:60s}
...
execute as @e[distance=..1,type=!#1_splatus:spellbound/misc] run damage @s 7 1_splatus:spellbound/explosion by @p[tag=spellbound_temp5]
