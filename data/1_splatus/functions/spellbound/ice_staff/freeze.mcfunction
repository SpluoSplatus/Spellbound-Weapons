...
execute as @s[scores={spellbound_freeze=1},type=!blaze] at @s run damage @s 4 1_splatus:spellbound/magic by @p[tag=spellbound_temp5]
execute as @s[scores={spellbound_freeze=1},type=blaze] at @s run damage @s 12 1_splatus:spellbound/magic by @p[tag=spellbound_temp5]
