...
execute as @s[scores={spellbound_i_staff_cooldown=50},predicate=1_splatus:spellbound/holding/weapon/ice_staff] at @s run item modify entity @s weapon.mainhand 1_splatus:spellbound/ice_staff_ready
execute as @s[scores={spellbound_i_staff_cooldown=50},predicate=1_splatus:spellbound/holding/weapon/ice_staff_offhand] at @s run item modify entity @s weapon.offhand 1_splatus:spellbound/ice_staff_ready
...
#click
execute as @s[scores={spellbound_i_staff_cooldown=50..,spellbound_right_click=1..}] at @s positioned ~ ~-.5 ~ run function 1_splatus:spellbound/ice_staff/attack
