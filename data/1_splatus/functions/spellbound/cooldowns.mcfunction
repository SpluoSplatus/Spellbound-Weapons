...
execute as @a[scores={spellbound_magmus_charger=0}] run advancement revoke @s only 1_splatus:spellbound/magmus_charger
execute as @a[scores={spellbound_blowgun=0}] run advancement revoke @s only 1_splatus:spellbound/blowgun
...
execute as @a[advancements={1_splatus:spellbound/magmus_charger=false}] at @s run scoreboard players set @s spellbound_magmus_charger_cooldown -1
