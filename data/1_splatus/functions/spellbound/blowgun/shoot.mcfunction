...
execute as @p[scores={spellbound_blowgun=1..}] at @s[predicate=1_splatus:spellbound/holding/weapon/blowgun] run item modify entity @s[gamemode=!creative] weapon.mainhand 1_splatus:spellbound/damage0.5
execute as @p[scores={spellbound_blowgun=1..}] at @s[predicate=1_splatus:spellbound/holding/weapon/blowgun_offhand] run item modify entity @s[gamemode=!creative] weapon.offhand 1_splatus:spellbound/damage0.5
execute as @p[scores={spellbound_blowgun=1..}] at @s[predicate=1_splatus:spellbound/holding/weapon/blowgun,predicate=!1_splatus:spellbound/holding/enchant/unbreaking3] run item modify entity @s[gamemode=!creative] weapon.mainhand 1_splatus:spellbound/damage0.5
execute as @p[scores={spellbound_blowgun=1..}] at @s[predicate=1_splatus:spellbound/holding/weapon/blowgun_offhand,predicate=!1_splatus:spellbound/holding/enchant/unbreaking3_offhand] run item modify entity @s[gamemode=!creative] weapon.offhand 1_splatus:spellbound/damage0.5



execute as @p[scores={spellbound_blowgun=1..}] unless entity @s[predicate=!1_splatus:spellbound/holding/enchant/infinity,predicate=!1_splatus:spellbound/holding/enchant/infinity_offhand] as @e[sort=nearest,limit=1,type=marker] run tag @s add spellbound_blowgun_arrow_raycast_infinity
execute as @p[scores={spellbound_blowgun=1..}] if score @s spellbound_blowgun_cooldown matches 16.. unless entity @s[predicate=!1_splatus:spellbound/holding/enchant/flame,predicate=!1_splatus:spellbound/holding/enchant/flame_offhand] as @e[sort=nearest,limit=1,type=marker] run tag @s add spellbound_blowgun_arrow_raycast_flame
...
#tip
execute as @p[scores={spellbound_blowgun=1..}] at @s as @s[tag=spellbound_tip.blowgun_1,tag=!spellbound_tip.blowgun_2] run function 1_splatus:spellbound/other/tips/checkmark
