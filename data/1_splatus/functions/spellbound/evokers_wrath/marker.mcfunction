...
execute as @s[scores={spellbound_count=2..}] at @s positioned ~ ~-.5 ~ run function 1_splatus:spellbound/evokers_wrath/fangs



execute at @s unless block ~ ~ ~ #1_splatus:spellbound/allows_water_dashing run function 1_splatus:spellbound/evokers_wrath/loop_to_ground
...
#execute as s[scores={spellbound_count=28}] at @s run function 1_splatus:spellbound/evokers_wrath/fangs
