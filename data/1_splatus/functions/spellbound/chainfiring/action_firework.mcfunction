...
#execute unless entity @s[predicate=!1_splatus:spellbound/holding/enchant/multishot_offhand,predicate=!1_splatus:spellbound/holding/enchant/multishot] if score @s spellbound_chainfiring_cooldown matches 206 run playsound minecraft:item.crossbow.shoot player @a[distance=..30] ~ ~ ~ 1 1


#execute unless entity @s[predicate=!1_splatus:spellbound/holding/enchant/multishot_offhand,predicate=!1_splatus:spellbound/holding/enchant/multishot] if score @s spellbound_chainfiring_cooldown matches 206 run playsound minecraft:item.crossbow.shoot player @a[distance=..30] ~ ~ ~ 1 1


#execute unless entity @s[predicate=!1_splatus:spellbound/holding/enchant/multishot_offhand,predicate=!1_splatus:spellbound/holding/enchant/multishot] if score @s spellbound_chainfiring_cooldown matches 206 run item modify entity @s[gamemode=!creative,gamemode=!spectator] weapon.offhand 1_splatus:spellbound/remove_one_offhand



#execute if score @s spellbound_chainfiring_cooldown matches 210 run item modify entity @s[gamemode=!creative,gamemode=!spectator] weapon.offhand 1_splatus:spellbound/remove_one_offhand
