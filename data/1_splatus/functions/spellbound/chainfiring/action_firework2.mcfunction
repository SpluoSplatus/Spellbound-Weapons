execute as @p[scores={spellbound_chainfiring_cooldown=1..5}] as @s[gamemode=!creative,gamemode=!spectator] run item modify entity @s[gamemode=!creative,gamemode=!spectator] weapon.offhand 1_splatus:spellbound/remove_two_offhand
