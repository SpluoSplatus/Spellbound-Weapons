...
execute at @s facing entity @p[scores={spellbound_sand=1..}] feet run tp @s ^ ^ ^-.001
...
execute store result entity @s Motion[0] double 0.06 run scoreboard players get @s spellbound_x2
execute store result entity @s Motion[1] double 0.06 run scoreboard players get @s spellbound_y2
execute store result entity @s Motion[2] double 0.06 run scoreboard players get @s spellbound_z2
