...
execute if predicate 1_splatus:spellbound/chance/25_percent run particle poof ~ ~-0.5 ~ .2 1 .2 .1 1 force @a[distance=..64]
...
execute if predicate 1_splatus:spellbound/chance/25_percent run playsound block.sand.hit neutral @a[distance=..20] ~ ~ ~ .25 .75
