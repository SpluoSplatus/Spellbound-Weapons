...
execute as @p[scores={spellbound_magmus_charger=1..}] unless entity @s[predicate=!1_splatus:spellbound/holding/enchant/power3,predicate=!1_splatus:spellbound/holding/enchant/power3_offhand] run tag @e[sort=nearest,limit=1,tag=spellbound_magmus_charger_arrow_area_max] add spellbound_magmus_charger_arrow_max_power3
execute as @p[scores={spellbound_magmus_charger=1..}] unless entity @s[predicate=!1_splatus:spellbound/holding/enchant/power4,predicate=!1_splatus:spellbound/holding/enchant/power4_offhand] run tag @e[sort=nearest,limit=1,tag=spellbound_magmus_charger_arrow_area_max] add spellbound_magmus_charger_arrow_max_power4
execute as @p[scores={spellbound_magmus_charger=1..}] unless entity @s[predicate=!1_splatus:spellbound/holding/enchant/power5,predicate=!1_splatus:spellbound/holding/enchant/power5_offhand] run tag @e[sort=nearest,limit=1,tag=spellbound_magmus_charger_arrow_area_max] add spellbound_magmus_charger_arrow_max_power5

execute as @p[scores={spellbound_magmus_charger=1..}] unless entity @s[predicate=!1_splatus:spellbound/holding/enchant/power3,predicate=!1_splatus:spellbound/holding/enchant/power3_offhand] run tag @e[sort=nearest,limit=1,tag=spellbound_magmus_charger_arrow_area_max] add spellbound_magmus_charger_arrow_max_power
execute as @p[scores={spellbound_magmus_charger=1..}] unless entity @s[predicate=!1_splatus:spellbound/holding/enchant/power4,predicate=!1_splatus:spellbound/holding/enchant/power4_offhand] run tag @e[sort=nearest,limit=1,tag=spellbound_magmus_charger_arrow_area_max] add spellbound_magmus_charger_arrow_max_power
execute as @p[scores={spellbound_magmus_charger=1..}] unless entity @s[predicate=!1_splatus:spellbound/holding/enchant/power5,predicate=!1_splatus:spellbound/holding/enchant/power5_offhand] run tag @e[sort=nearest,limit=1,tag=spellbound_magmus_charger_arrow_area_max] add spellbound_magmus_charger_arrow_max_power
