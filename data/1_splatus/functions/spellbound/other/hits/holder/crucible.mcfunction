...
execute if score @s spellbound_crucible_hitcool matches 24.. if entity @e[distance=..5,type=!#1_splatus:spellbound/crucible_non_energy,nbt={HurtTime:10s}] run scoreboard players add @s spellbound_crucible_energy 80
