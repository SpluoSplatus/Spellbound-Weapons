...
execute as @s[predicate=1_splatus:spellbound/holding/enchant/sweeping_edge3] run tag @e[type=marker,tag=spellbound_evokerattack,tag=!spellbound_evokerattack_checked,sort=nearest,limit=1] add spellbound_enchanted_sweeping3
execute as @s[predicate=1_splatus:spellbound/holding/enchant/sweeping_edge2] run tag @e[type=marker,tag=spellbound_evokerattack,tag=!spellbound_evokerattack_checked,sort=nearest,limit=1] add spellbound_enchanted_sweeping2
