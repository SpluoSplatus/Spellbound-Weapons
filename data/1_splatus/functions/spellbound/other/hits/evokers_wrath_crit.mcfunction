...
execute if predicate 1_splatus:spellbound/holding/enchant/sweeping_edge3 run summon marker ~ ~ ~2 {Tags:["spellbound_evokerattack","spellbound_temp2","spellbound_marker","spellbound_evokerattack_crit"]}
execute if predicate 1_splatus:spellbound/holding/enchant/sweeping_edge3 run summon marker ~ ~ ~-2 {Tags:["spellbound_evokerattack","spellbound_temp2","spellbound_marker","spellbound_evokerattack_crit"]}
execute if predicate 1_splatus:spellbound/holding/enchant/sweeping_edge3 run summon marker ~2 ~ ~ {Tags:["spellbound_evokerattack","spellbound_temp2","spellbound_marker","spellbound_evokerattack_crit"]}
execute if predicate 1_splatus:spellbound/holding/enchant/sweeping_edge3 run summon marker ~-2 ~ ~ {Tags:["spellbound_evokerattack","spellbound_temp2","spellbound_marker","spellbound_evokerattack_crit"]}
...
execute if predicate 1_splatus:spellbound/holding/enchant/sweeping_edge3 at @e[type=marker,tag=spellbound_temp2] run data modify entity @e[type=marker,limit=1,sort=nearest] data.Owner set from entity @s UUID
execute if predicate 1_splatus:spellbound/holding/enchant/sweeping_edge3 as @e[type=marker,tag=spellbound_temp2] run tag @s remove spellbound_temp2
...
summon vex ~ ~2 ~ {Tags:["spellbound_evoker_vex","spellbound_marker"],Invulnerable:1b,Attributes:[{Base:-999.00d,Name:"generic.attack_damage"}]}
summon vex ~ ~2 ~ {Tags:["spellbound_evoker_vex","spellbound_marker"],Invulnerable:1b,Attributes:[{Base:-999.00d,Name:"generic.attack_damage"}]}
execute if predicate 1_splatus:spellbound/chance/10_percent run summon allay ~ ~2 ~ {Tags:["spellbound_evoker_vex","spellbound_marker"],Invulnerable:1b,Attributes:[{Base:-999.00d,Name:"generic.attack_damage"}]}
...
#execute at @s[predicate=1_splatus:spellbound/holding/enchant/sweeping_edge3] run summon evoker_fangs ^ ^1 ^11 {Tags:["spellbound_evokerattack","spellbound_temp","spellbound_marker","spellbound_evokerattack_crit0"]}


execute as @s[tag=spellbound_tip.evokers_wrath_2,tag=!spellbound_tip.evokers_wrath_3] run function 1_splatus:spellbound/other/tips/checkmark
