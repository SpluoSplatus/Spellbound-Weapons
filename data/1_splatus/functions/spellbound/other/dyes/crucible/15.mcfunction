...
data modify entity @s Item.tag.display set value {Name:'{"translate":"Crucible","color":"gray","italic":false}',Lore:['{"translate":"Color: Gray","color":"gray","italic":false}','[{"translate":"Grindstone Repair: ","color":"gray","italic": false},{"translate":"item.minecraft.diamond_sword"}]','{"translate":"Spellbound Weapons","color":"#676E75","italic":true}']}
