...
execute store result entity @s[type=wither] Motion[0] double 0.001 run scoreboard players get @s spellbound_x2
execute store result entity @s[type=wither] Motion[1] double 0.001 run scoreboard players get @s spellbound_y2
execute store result entity @s[type=wither] Motion[2] double 0.001 run scoreboard players get @s spellbound_z2

#execute store result entity @s power[0] double 0.0001155 run scoreboard players get @s spellbound_x2
#execute store result entity @s power[1] double 0.0001155 run scoreboard players get @s spellbound_y2
#execute store result entity @s power[2] double -0.0001155 run scoreboard players get @s spellbound_z2





tag @s remove spellbound_player2
