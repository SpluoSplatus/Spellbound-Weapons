...
execute store result entity @s Motion[0] double 0.00025 run scoreboard players get @s spellbound_x2
execute store result entity @s Motion[1] double 0.00025 run scoreboard players get @s spellbound_y2
execute store result entity @s Motion[2] double 0.00025 run scoreboard players get @s spellbound_z2
...
tag @s remove spellbound_player4
