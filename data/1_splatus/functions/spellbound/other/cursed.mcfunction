...
execute as @s[scores={spellbound_curse_time=1..2},type=!wither,type=!ender_dragon] run data merge entity @s {DeathLootTable:"1_splatus:spellbound/entity/fish_curse"}
