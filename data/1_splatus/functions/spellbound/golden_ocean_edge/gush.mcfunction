...
execute unless block ~ ~-.5 ~ #1_splatus:spellbound/permeable run function 1_splatus:spellbound/golden_ocean_edge/gush_loop
execute unless block ~ ~-.5 ~ #1_splatus:spellbound/permeable run kill @s
