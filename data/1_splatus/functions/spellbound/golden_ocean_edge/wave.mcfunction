...
execute if block ~ ~ ~ #1_splatus:spellbound/fire if predicate 1_splatus:spellbound/chance/20_percent run function 1_splatus:spellbound/golden_ocean_edge/wave_remove_fire
...
execute if predicate 1_splatus:spellbound/chance/25_percent run particle poof ~ ~ ~ ~ ~1000000000 ~ 0.00000000005 0 force @a[distance=..128]
